      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="col-span-1 md:col-span-2">
            <h3 className="mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-bold text-2xl text-transparent">
              Boilerplate
            </h3>
            <p className="mb-4 text-gray-400">
              Build your next amazing project with our beautiful boilerplate.
